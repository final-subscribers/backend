...
class AuthSendEmailServiceTest {
    ...
    void sendVerificationCode_ShouldSendCode_WhenEmailIsNotDuplicated() {
        ...
        doNothing().when(sendEmailService).sendVerifyEmail(anyString(), anyString(), anyString());
        ...
        verify(sendEmailService).sendVerifyEmail(eq(email), eq("시행사 회원가입 인증코드입니다"), anyString());
    }
